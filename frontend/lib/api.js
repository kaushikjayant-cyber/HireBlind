/**
 * Centralized API client for HireBlind Express backend.
 ...
 *
 * All requests send `X-User-Id` header so the Express RBAC middleware
 * can verify the caller's role from the `users` table.
 */
